...
-   [CSViz: Class Separability Visualization for
    high-dimensional](https://link.springer.com/article/10.1007/s10489-023-05149-4)

    [
    datasets](https://link.springer.com/article/10.1007/s10489-023-05149-4)

    Repositorio asociado: <https://github.com/URJCDSLab/CSViz>

-   [Importance of Visual Support Through Lipreading in the
    ](https://journals.sagepub.com/doi/10.1177/00238309241270741)

    [Identification of Words in Spanish
    Language](https://journals.sagepub.com/doi/10.1177/00238309241270741)
...
- Obra colectiva [Fundamentos de ciencia de datos con R](https://cdr-book.github.io) editada por Gema Fernández-Avilés.
...
::: columns
::: {.column width="60%"}
-   [Embresa biotecnológica](https://shapypro.com)
-   Proficiency Testing
...
* <http://e-imasde.eu/language/es/home/>
...
-   Casos de uso para turismo, Use cases for Tourism, Healthcare, and Infrastructures in Madrid
    Region
